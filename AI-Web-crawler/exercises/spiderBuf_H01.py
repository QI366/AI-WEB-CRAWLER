...
outdir = Path(__file__).resolve().parent / 'data' / 'h01'
...
f = open(outdir / 'h01.html', 'w', encoding='utf-8')
...
f = open(outdir / 'h01.txt', 'w', encoding='utf-8')
...
# 来源：https://spiderbuf.cn/code/scraping-css-confuse-offset
# 爬虫练习网站：Spiderbuf