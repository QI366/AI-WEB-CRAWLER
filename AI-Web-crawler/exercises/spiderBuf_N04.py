...
outdir = Path(__file__).resolve().parent / 'data' / 'n04'
outdir.mkdir(parents=True, exist_ok=True)


base_url = 'https://spiderbuf.cn/challenge/css-pseudo-elements'
...
def parseHTML(html):
    ...
    # 用 // 而不是绝对路径：目标 div 实际嵌在 body 下 5 层，层数一变绝对路径就失效
    divs = root.xpath('//div[@style="margin-top: 10px;"]')
...
if __name__ == '__main__':
    ...
    html = getHTML(base_url, str(outdir / 'n04.html'))
...
# 来源：https://spiderbuf.cn/code/css-pseudo-elements
# 爬虫练习网站：Spiderbuf